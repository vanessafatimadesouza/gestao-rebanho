...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-[#f6faf7] flex flex-col">
    ...
    <main id="conteudo-principal" tabIndex={-1} className="mx-auto w-full max-w-[1360px] flex-1 px-4 py-6 sm:px-10 md:pb-[96px] lg:px-16 lg:pt-8 xl:px-20">{children}</main>
